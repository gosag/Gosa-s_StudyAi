...
export const uploadFile = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try{
       if (!req.user || !req.user._id) {
        ...
        const flashcardResponse=await generateFlashCards(parsedResponse,user.apiKey || undefined);
...
export const uploadLink = async (req: Request, res: Response, next: NextFunction) => {
  ...
  if(!user.apiKey){
    ...
    const flashcardResponse=await generateFlashCards(sumamrizedResponse, user.apiKey || undefined)
    await Flashcard.insertMany(
          flashcardResponse.map((flashcard:any)=>({
            ...flashcard,
            userId,
